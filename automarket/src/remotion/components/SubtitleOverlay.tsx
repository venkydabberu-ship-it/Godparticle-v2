...
export function SubtitleOverlay({ words, style = 'bold', wordsPerChunk = 3 }: Props) {
  ...
  const styles = {
    bold: {
      ...
      word: (active: boolean) => ({ fontFamily: 'Arial Black, Arial, sans-serif', fontWeight: 900, fontSize: 68, color: active ? '#f0c040' : '#ffffff', textShadow: '0 4px 20px rgba(0,0,0,0.9), 0 2px 6px rgba(0,0,0,1)', display: 'inline-block' as const, lineHeight: 1.15 }),
    },
    minimal: {
